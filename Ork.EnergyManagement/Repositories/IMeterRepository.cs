...
namespace Ork.EnergyManagement.Repositories
{
  ...
  {
    DataServiceQuery<Meter> Meters { get; }
    IEnumerable<EntityDescriptor> Entities { get; }
    DataServiceQuery<ScheduledTask> MeterReadings { get; }
    bool HasConnection { get; }
    IEnumerable<LinkDescriptor> Links { get; }
    DataServiceQuery<Map> Maps { get; }
    DataServiceQuery<ResponsibleSubject> ResponsibleSubjects { get; }
    DataServiceQuery<Series> Series { get; }
